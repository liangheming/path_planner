...
{
public:
    TebLocalPlanner(FollowerInfo *follower_info, costmap_2d::Costmap2D *costmap, RobotModel *robot_model);
    ...
    Point2Ds &mutableObstacles() { return _optimizer.mutableObstacles().mutablePoints(); }
