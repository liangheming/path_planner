...
double CircleRobotModel::distanceToPoint(const Point2E &pose, const Point2D &point) const
{
...
double PolygonRobotModel::distanceToPoint(const Point2E &pose, const Point2D &point) const
{
